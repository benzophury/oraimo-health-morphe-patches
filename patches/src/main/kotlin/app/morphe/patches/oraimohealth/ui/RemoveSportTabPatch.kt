...
/**
 * Patch that removes the Sports/Workout tracking tab from the bottom navigation bar.
 */
@Suppress("unused")
val removeSportTabPatch = bytecodePatch(
    name = "Remove Sport Tab",
    description = "Hides the GPS sports and workout tracking tab from the bottom navigation bar.",
    default = true
) {
