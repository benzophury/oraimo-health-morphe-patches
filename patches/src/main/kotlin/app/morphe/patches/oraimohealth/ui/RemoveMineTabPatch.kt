...
/**
 * Patch that removes the User Profile / Mine tab from the bottom navigation bar.
 */
@Suppress("unused")
val removeMineTabPatch = bytecodePatch(
    name = "Remove Mine Tab",
    description = "Hides the User Profile and Account tab from the bottom navigation bar.",
    default = true
) {
